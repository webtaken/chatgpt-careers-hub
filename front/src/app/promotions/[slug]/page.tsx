...
export async function generateMetadata({ params }: Params): Promise<Metadata> {
  ...
  return {
    title: `${post.title} | ChatGPT Jobs Promotions`,
    description:
      description || `Explore promotion: ${post.title} on ChatGPT Jobs.`,
    keywords: [
      "ChatGPT jobs",
      "AI jobs",
      "promotion",
    ...
    alternates: {
      canonical: `https://www.chatgpt-jobs.com/promotions/${params.slug}`,
    },
    openGraph: {
      title: post.title,
      description:
        description || `Explore promotion: ${post.title} on ChatGPT Jobs.`,
      url: `https://www.chatgpt-jobs.com/promotions/${params.slug}`,
...
export default async function PromotionDetailPage({ params }: Params) {
  setBasePathToAPI();
  const post = await apiNewsletterPostsBySlugRetrieve({
    slug: params.slug,
  }).catch(() => null);
